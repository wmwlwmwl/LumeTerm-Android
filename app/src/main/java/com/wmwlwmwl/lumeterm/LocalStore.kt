...
data class WebDavConfig(
    ...
    val username: String = "",
    val password: String = "",
    val remotePath: String = "/LumeTerm/",
...
class LocalStore(context: Context) {
    ...
    fun loadWebDavConfig() = WebDavConfig(
        ...
        remotePath = prefs.getString("webdav_remote_path", "/LumeTerm/") ?: "/LumeTerm/",
    ...
    fun loadR2Config() = R2Config(
        ...
        prefix = prefs.getString("r2_prefix", "LumeTerm/") ?: "LumeTerm/",
    ...
    fun loadFtpConfig() = FtpConfig(
        ...
        remoteDir = prefs.getString("ftp_remote_dir", "/LumeTerm/") ?: "/LumeTerm/",
    ...
    fun loadSftpConfig() = SftpConfig(
        ...
        remoteDir = prefs.getString("sftp_remote_dir", "/LumeTerm/") ?: "/LumeTerm/",
